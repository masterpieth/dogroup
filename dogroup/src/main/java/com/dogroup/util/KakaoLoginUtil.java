...
public class KakaoLoginUtil {
	 ...
	 */
	private static String CLIENT_ID_FILE_PATH = "C:\\kakao_client_id.txt";
	 ...
	 */
	public static final String AUTHORIZE_URL = "https://kauth.kakao.com/oauth/authorize";
	public static final String REDIRECT_URL = "/user/auth/kakao/callback";
	public static final String ACCESS_TOKEN_URL = "https://kauth.kakao.com/oauth/token";
